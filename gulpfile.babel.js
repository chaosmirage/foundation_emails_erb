...
function pages() {
  return gulp.src('src/pages/**/*.html')
    ...
    .pipe(through.obj(function(chunk, enc, cb) {
        chunk.contents = Buffer(he.decode(String(chunk.contents)));
        cb(null, chunk);
    }))
    .pipe(gulp.dest('dist'));
}
...
function watch() {
  ...
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss', '../scss/**/*.sass', 'src/assets/scss/**/*.sass']).on('all', gulp.series(resetPages, sass, pages, inline, browser.reload));
